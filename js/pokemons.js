...
const elWrapper = document.querySelector(".wrapper");
    ...
    for (let i = 0; i < pokemons.length; i++) {
		...
		let newTextType = document.createElement("p");
        let newTextWeight = document.createElement("p");
        let newTextHeight = document.createElement("p");

		newCard.setAttribute("class" , "card mt-5 mb-5 ms-3 bg-light rounded-3");
		newCard.setAttribute("style" , "width: 15rem; height: 21rem;");
		newCardBody.setAttribute("class" , "card-body");
		newTextWrapper.setAttribute("class" , "d-flex mt-2");
		newImg.setAttribute("src" , pokemons[i].img);
		newImg.setAttribute("class" , "card-img-top");
		newImg.setAttribute("style" , "height: 12rem;");
		newTitle.setAttribute("class" , "h5 fw-bolder card-title text-center");
        newTitle.textContent = "Name: " + pokemons[i].name;
		newTextType.setAttribute("class" , "card-text m-0 text-secondary text-center");
		newTextType.textContent = "Type: "+ pokemons[i].type;
		newTextWeight.setAttribute("class" , "card-text m-0 text-info");
		newTextWeight.textContent = "Weight: " + pokemons[i].weight;
		newTextHeight.setAttribute("class" , "card-text m-0 text-success ms-5");
		newTextHeight.textContent = "Height: " +  pokemons[i].height;
		...
		newCardBody.appendChild(newTextType);
		newCardBody.appendChild(newTextWrapper);
		newTextWrapper.appendChild(newTextWeight);
		newTextWrapper.appendChild(newTextHeight);
    }